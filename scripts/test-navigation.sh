#!/bin/bash
# Test script for navigation edge function
...
# Configuration
FUNCTION_URL="http://127.0.0.1:54321/functions/v1/navigation"
...
echo -e "${YELLOW}======================================${NC}"
echo -e "${YELLOW}Testing navigation edge function${NC}"
echo -e "${YELLOW}======================================${NC}\n"
...
# Test payload - POST to create navigation
REQUEST_BODY='{
  "courseId": "00000000-0000-0000-0000-000000000001",
  "currentLeafId": "00000000-0000-0000-0000-000000000002"
}'

echo -e "${YELLOW}Test 1: POST /navigation (Create)${NC}"
